package com.project.laolang.androidsubassembly;
...
public class SupportDisplay {
     ...
     * 基准屏幕宽
     */
    private static final float BASIC_SCREEN_WIDTH = 750f;
    /**
     * 基准屏幕高
     */
     ...
     * @return
     */
    public static int getNomoalSizeY(int sizepx) {
        return (int) ((sizepx - COMPLEMENT_VALUE) / mLayoutScale);
    }
    ...
    public static int getTextSize(int sizesp) {
        return (int) (sizesp
     ...
     * @return
     */
    public static int getFinalSize(int sizepx) {
        return (int) calculateActualControlerSize(calculateActualControlerSize(sizepx));
    }
    ...
    public static float getContrlerTextSize(float textSizedp) {
        return textSizedp
                * mLayoutScale * mDensityScale;
    }
